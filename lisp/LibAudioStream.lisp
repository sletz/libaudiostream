...
;................................................................................: MakeBufferSound
(cffi:defcfun ("MakeBufferSound" make-buffer-sound-ptr) sound-ptr (buffer :pointer) (length :long) (channels :long))
(defun MakeBufferSound (buffer length channels)
  (register-for-cleanup
   (make-las-sound :ptr (make-buffer-sound-ptr buffer length channels))))
...
;................................................................................: GenRealDate
(cffi:defcfun ("GenRealDate" gen-real-date) symbolic-date (player audio-player) (date audio_frame_t))
(defun GenRealDate (player date) (gen-real-date player date))
;................................................................................: GetSymbolicDate
(cffi:defcfun ("GetSymbolicDate" get-symbolic-date) audio_frame_t (player audio-player) (symb-date symbolic-date))
(defun GetSymbolicDate (player symb-date) (get-symbolic-date player symb-date))
;................................................................................: SetSymbolicDate
(cffi:defcfun ("SetSymbolicDate" set-symbolic-date) :long (player audio-player) (symb-date symbolic-date) (real-date audio_frame_t))
